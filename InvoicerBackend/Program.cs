                ...
                if (L.User != null)
                {
                    ...
                    if (UserE != null)
                    {
                        ...
                        if (Password != null && Utils.DoPBKDF2(L.Password) == Password)
                        {
                            ...
                            if (UserA == null || UserPC == null || UserE == null) Console.Error.WriteLine($"UserA:{UserA} UserPC:{UserPC} UserE:{UserE}");
                            ctx.Tokens.Add(
                                new Token()
                                {
                                    Tokenid = Tid,
...
app.AddEndpoint<string>("AutogeneratedClockEndpoint", (R) => { return DateTime.UtcNow.ToString("O"); }, "VIEW_SERVER_TIME");
