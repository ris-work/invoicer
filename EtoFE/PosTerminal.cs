...
namespace EtoFE
{
    ...
    public class PosTerminal : Form
    {
        public PosTerminal()
        {
            ...
            Button CheckTimeButtonAG = new Button()
            {
                Text = "Check Server Time (Autogenerated Endpoint)",
            };
            Button CheckTimeButtonAGBA = new Button()
            {
                Text = "Check Server Time (Autogenerated Endpoint)",
            };
            ...
            TL.Rows.Add(new TableRow(CheckTimeButtonAG, CheckTimeButtonAGBA));
            PosData.Wait();
            ...
            CheckTimeButtonAG.Click += (e, a) =>
            {
                while (true)
                {
                    var req = (
                        new AuthenticationForm<string, SingleValueString>(
