...
namespace EtoFE
{
    ...
    public class PosTerminal : Form
    {
        public PosTerminal()
        {
            ...
            Button CheckTimeButtonAG = new Button() { Text = "Check Server Time (Autogenerated Endpoint)" };
            ...
            TL.Rows.Add(new TableRow(CheckTimeButtonAG));
            PosData.Wait();
            ...
            CheckTimeButtonAG.Click += (e, a) =>
            {
                ...
                {
                    var req = (
                        new AuthenticationForm<string, SingleValueString>("/AutogeneratedClockEndpoint", "Time")
                    );
                    req.ShowModal();
                    if (req.Error == false)
                    {
