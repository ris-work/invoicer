...
namespace AuthManager
{
    class NotificationsViewer : Eto.Forms.Dialog
    {
        public NotificationsViewer()
        {
            ...
            NotificationsGridView.Columns.Add(
                new GridColumn() { HeaderText = "Notification Type", DataCell = new TextBoxCell(1) }
            );
            NotificationsGridView.Columns.Add(
                new GridColumn()
                {
            ...
            NotificationsGridView.Columns.Add(
                new GridColumn() { HeaderText = "Notification Time", DataCell = new TextBoxCell(5) }
            );
            NotificationsGridView.Columns.Add(
                new GridColumn()
                {
