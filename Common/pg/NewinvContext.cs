...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AccountsInformation>(entity =>
        {
            ...
            entity.Property(e => e.AllowDebitOnPos)
                .HasDefaultValue(false)
            ...
            entity.Property(e => e.IsDefaultCashRegister)
                .HasDefaultValue(false)
                .HasColumnName("is_default_cash_register");
            entity.Property(e => e.IsInventoryTracked)
                .HasDefaultValue(false)
                .HasColumnName("is_inventory_tracked");
            entity.Property(e => e.IsReconcilable)
                .HasDefaultValue(false)
        ...
        modelBuilder.Entity<AccountsJournalEntry>(entity =>
        {
            ...
            entity.Property(e => e.JournalUnivSeq)
                .UseIdentityAlwaysColumn()
                .HasColumnName("journal_univ_seq");
            entity.Property(e => e.Amount).HasColumnName("amount");
            entity.Property(e => e.CreditAccountName)
        ...
        modelBuilder.Entity<Catalogue>(entity =>
        {
            ...
            entity.Property(e => e.AllowPriceSuggestions)
                .HasDefaultValue(true)
            ...
            entity.Property(e => e.MaxPerPerson)
                .HasDefaultValueSql("1000000")
        ...
        {
            entity.HasKey(e => new { e.Code, e.Itemcode, e.Batchcode }).HasName("codes_batches_pkey");
        ...
        modelBuilder.Entity<CustomerDiscount>(entity =>
        {
            ...
            entity.Property(e => e.LoyaltyPaidToAccountId).HasColumnName("loyalty_paid_to_account_id");
        ...
        modelBuilder.Entity<DefaultDenyField>(entity =>
        {
            ...
            entity.ToTable("default_deny_fields", tb => tb.HasComment("Of the form [object].[field] or [field]"));
        ...
        {
            entity.HasKey(e => e.EntryId).HasName("inventory_adjustments_pkey");

            entity.ToTable("inventory_adjustments");

            entity.Property(e => e.EntryId).HasColumnName("entry_id");
            entity.Property(e => e.AdjustmentBatch).HasColumnName("adjustment_batch");
            entity.Property(e => e.AfterQty).HasColumnName("after_qty");
            entity.Property(e => e.Batchcode).HasColumnName("batchcode");
            entity.Property(e => e.BeforeQty).HasColumnName("before_qty");
            ...
            entity.Property(e => e.PerItemValue).HasColumnName("per_item_value");
        ...
        modelBuilder.Entity<IssuedInvoice>(entity =>
        {
            ...
            entity.Property(e => e.InvoiceTimePosted)
                .HasDefaultValueSql("now()")
                .HasColumnType("time with time zone")
        ...
        modelBuilder.Entity<Payment>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.CompanyId, e.BankAccountId, e.IsReconciled, e.IsExcluded }, "ix_payments_recon");
        ...
        modelBuilder.Entity<PiiImage>(entity =>
        {
            ...
            entity.ToTable("pii_images", tb => tb.HasComment("Photos of people, companies - any person, including non-natural persons."));
        ...
        modelBuilder.Entity<Purchase>(entity =>
        {
            ...
            entity.Property(e => e.FreePacks)
                .HasDefaultValue(0L)
                .HasColumnName("free_packs");
            ...
            entity.Property(e => e.ManufacturerBatchId)
                .HasDefaultValueSql("''::text")
            ...
            entity.Property(e => e.ReceivedAsUnitQuantity).HasColumnName("received_as_unit_quantity");
            ...
            entity.Property(e => e.VatCategory)
                .HasDefaultValue(0L)
                .HasColumnName("VAT_category");
            entity.Property(e => e.VatCategoryName)
                .HasDefaultValueSql("''::text")
        ...
        modelBuilder.Entity<ReceivedInvoice>(entity =>
        {
            ...
            entity.Property(e => e.DefaultVatCategory)
                .HasDefaultValue(0L)
                .HasColumnName("default_VAT_category");
            entity.Property(e => e.DefaultVatCategoryName)
                .HasDefaultValueSql("''::text")
                .HasColumnName("default_VAT_category_name");
            entity.Property(e => e.DefaultVatPercentage).HasColumnName("default_VAT_percentage");
            entity.Property(e => e.EffectiveDiscountAbsoluteFromEnteredItems).HasColumnName("effective_discount_absolute_from_entered_items");
            entity.Property(e => e.EffectiveDiscountAbsoluteTotal).HasColumnName("effective_discount_absolute_total");
        ...
        modelBuilder.Entity<Request>(entity =>
        {
            ...
            entity.Property(e => e.DatetimeTai)
                .HasDefaultValueSql("now()")
        ...
        modelBuilder.Entity<Sale>(entity =>
        {
            ...
            entity.Property(e => e.Batchcode).HasColumnName("batchcode");
            entity.Property(e => e.ClientRecordedTimeClosing)
                .HasDefaultValueSql("now()")
                .HasColumnName("client_recorded_time_closing");
            entity.Property(e => e.ClientRecordedTimeOpening)
                .HasDefaultValueSql("now()")
        ...
        modelBuilder.Entity<ScheduledPayment>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.NextRunDate, e.IsPending }, "ix_scheduled_payments_next_run");

            entity.HasIndex(e => new { e.CompanyId, e.BankAccountId, e.IsReconciled, e.IsExcluded }, "ix_scheduled_payments_recon");

            entity.HasIndex(e => new { e.IsProcessing, e.IsCompleted, e.IsFailed, e.IsCancelled }, "ix_scheduled_payments_status_flags");
            ...
            entity.Property(e => e.CreatedBy).HasColumnName("created_by");
            entity.Property(e => e.CreditAccountId).HasColumnName("credit_account_id");
            entity.Property(e => e.CreditAccountType)
                .HasDefaultValue(0L)
                .HasColumnName("credit_account_type");
            entity.Property(e => e.Currency).HasColumnName("currency");
            entity.Property(e => e.DebitAccountId).HasColumnName("debit_account_id");
            entity.Property(e => e.DebitAccountType)
                .HasDefaultValue(3L)
            ...
            entity.Property(e => e.InvoiceId).HasColumnName("invoice_id");
            entity.Property(e => e.IsAutomaticClear)
                .HasDefaultValue(true)
        ...
        modelBuilder.Entity<ScheduledReceipt>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.NextRunDate, e.IsPending }, "ix_scheduled_receipts_next_run");

            entity.HasIndex(e => new { e.CompanyId, e.BankAccountId, e.IsReconciled, e.IsExcluded }, "ix_scheduled_receipts_recon");

            entity.HasIndex(e => new { e.IsProcessing, e.IsCompleted, e.IsFailed, e.IsCancelled }, "ix_scheduled_receipts_status_flags");
        ...
        modelBuilder.Entity<UsersFieldLevelAccessControlsDenyList>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("users_field_level_access_controls_deny_list");
